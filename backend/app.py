...
def update_historique(historique_id):
    ...
    return jsonify({'message': 'Historique non trouvé ou aucune modification effectuée'}), 404
...
def update_trajet(trajet_id):
    ...
    return jsonify({'message': 'Trajet non trouvé ou aucune modification effectuée'}), 404
...
def update_zone(zone_id):
    ...
    return jsonify({'message': 'Zone non trouvée ou aucune modification effectuée'}), 404
...
def update_poubelle(poubelle_id):
    ...
    return jsonify({'message': 'Poubelle non trouvée ou aucune modification effectuée'}), 404
...
def update_collecteur(collecteur_id):
    ...
    return jsonify({'message': 'Collecteur non trouvé ou aucune modification effectuée'}), 404
